async function getLocationData(latitude, longitude) {
  const url = `https://api.bigdatacloud.net/data/reverse-geocode-client?latitute=${latitude}&longitude=${longitude}&localityLanguage=en`;
...
function getStartDate(ride) {
  ...
  return `at ${hour}:${minute.padStart(2, '0')} on ${month} ${day}, ${year}`;
}
